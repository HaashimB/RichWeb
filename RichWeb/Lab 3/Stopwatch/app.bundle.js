...
const source = __WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.interval(100 /* ms */).timeInterval();
...
__WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.fromEvent(document.getElementById('start'), 'click').subscribe(e => {
    started = true;
});

__WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.fromEvent(document.getElementById('stop'), 'click').subscribe(e => {
    started = false;
});

__WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.fromEvent(document.getElementById('split'), 'click').subscribe(e => {
    splitsList.innerHTML += digital.innerHTML + "<br/>";
});

__WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.fromEvent(document.getElementById('reset'), 'click').subscribe(e => {
    started = false;
    time = 0;
    draw(time);
